...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Atualiza a sessão (cria novo cookie)
    // Nota: precisamos obter um idToken válido para criar a sessão
    // Por enquanto, vamos apenas redirecionar e deixar o middleware cuidar da sessão
